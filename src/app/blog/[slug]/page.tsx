    ...
    return (
      <main className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/" className="text-accent hover-accent text-display text-sm tracking-widest">
            ← Back to Home
          </Link>
        </div>
      </main>
    ...
    <>
      <article>
        <header className="relative h-[70vh] overflow-hidden">
          {post.featured_image && (
            <img src={post.featured_image} alt={post.title} fetchPriority="high" className="w-full h-full object-cover" />
          )}
        ...
        <div className="max-w-6xl mx-auto px-6 pt-12 flex items-center justify-between">
          <Link href="/" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover-accent transition-colors text-display tracking-wider">
          ...
          {post.hinglish_content && (
            <button
              ...
              className={`inline-flex items-center gap-2 px-4 py-2 border text-display text-xs tracking-widest transition-colors ${isHinglish ? "border-accent text-accent" : "border-border text-muted-foreground hover:border-accent hover:text-foreground"
                }`}
            >
