  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <h2
          className="text-display text-[11vw] sm:text-[12vw] md:text-[11.5vw] lg:text-[12vw] font-bold text-foreground whitespace-nowrap w-full text-center leading-none tracking-normal"
          style={{
